...
import Controller from './TimesheetController'
import Validations from './TimesheetValidations'
...
const WRITE_ROLES = [ROLE_TYPES.ADMIN, ROLE_TYPES.PROJECT_MANAGER, ROLE_TYPES.TEAM_MEMBER]

...
import { REGEXP, PURCHASE_ORDER_STATUS } from '../../../utils/constants'

const ALLOWED_STATUS = Object.values(PURCHASE_ORDER_STATUS)
...
class PurchaseOrderValidations {
  ...
  list = (req: Request, res: Response, next: NextFunction) => {
    const { page, limit, status, project_uuid, vendor_uuid, date_from, date_to } = req.query
...
export default new PurchaseOrderValidations()
